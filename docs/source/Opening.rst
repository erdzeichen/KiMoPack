...
:meth:`self.__make_standard_parameter()<KiMoPack.plot_func.TA.__make_standard_parameter>` function. 
...
For more details see the examples in :meth:`pf.GUI_open()<KiMoPack.plot_func.GUI_open>`
